...
if __name__ == '__main__':
    ...
    ol = 0
    pd = 0
    create_dataset(data_dir=r'/scratch/sr365/Catalyst_data/h2_RTI_negative/',
                   save_dir=r'/scratch/sr365/Catalyst_data/h2_RTI_negative/', patch_size=(ps, ps), pad=pd, overlap=ol, visualize=False)
