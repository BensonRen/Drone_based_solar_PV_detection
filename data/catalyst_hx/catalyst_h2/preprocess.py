...
if __name__ == '__main__':
    ...
    ol = 0
    pd = 0
    dir_name = r'/scratch/sr365/Catalyst_data/h2'
    for motion_blur in range(2, 7):
        data_dir = dir_name  + '_mb_{}'.format(motion_blur - 1)
        create_dataset(data_dir=data_dir,save_dir=data_dir, 
                        patch_size=(ps, ps), pad=pd, overlap=ol, visualize=False)
