...
# Settings
DS_NAME = 'RTI_negative'


def get_images(data_dir, valid_percent=0.05, split=False):
...
if __name__ == '__main__':
    ...
    ol = 0
    pd = 0
    create_dataset(data_dir=r'/scratch/sr365/RTI_data/subsampled_negative_10percent',
                   save_dir=r'/scratch/sr365/RTI_data/subsampled_negative_10percent', patch_size=(ps, ps), pad=pd, overlap=ol, visualize=False)
